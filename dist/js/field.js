    ...
    _c(
      ...
      [
        _vm.field.heading && _vm.field.display_stacked
          ...
          : _vm._e(),
        _vm._v(" "),
        _vm._l(_vm.field.sub_fields, function(subField, fieldIndex) {
          return _c(subField.type + "-sub-field", {
            key: fieldIndex,
            tag: "component",
            staticClass: "row-input",
            class: _vm.getInputLayout(subField),
            attrs: { "sub-field": subField, index: _vm.index },
            model: {
